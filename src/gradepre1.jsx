...
const Gradepre1=()=>{
  ...
  const [textValue1, setTextValue1] = useState("i");
  const [textValue2, setTextValue2] = useState("m");
  const [textValue3, setTextValue3] = useState("p");
  const [textValue4, setTextValue4] = useState("g");
  ...
  const [textValue6, setTextValue6] = useState("a o");
  const [textValue7, setTextValue7] = useState("m o");
  const [textValue8, setTextValue8] = useState("d o");
  const [textValue9, setTextValue9] = useState("i p o");
  const [textValue10, setTextValue10] = useState("I s o");
