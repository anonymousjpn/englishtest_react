...
const Gradepre2=()=>{
  ...
  const [textValue1, setTextValue1] = useState("l");
  const [textValue2, setTextValue2] = useState("m");
  const [textValue3, setTextValue3] = useState("n");
  const [textValue4, setTextValue4] = useState("p");
  const [textValue5, setTextValue5] = useState("h");
  ...
  const [textValue6, setTextValue6] = useState("d o");
  const [textValue7, setTextValue7] = useState("s f");
  const [textValue8, setTextValue8] = useState("p a t");
  const [textValue9, setTextValue9] = useState("c h b i");
  const [textValue10, setTextValue10] = useState("h n t d w");
  const [submitted, setSubmitted] = useState(false);
  const [deleted, setDeleted] = useState(false);
  const [countWords, setCountWords] = useState(0);
  const [countIdioms, setCountIdioms] = useState(0);
  useEffect(() => {
    if (submitted) {
      let correctWords = 0;
      let correctIdioms = 0;
  ...
  function results(countWords, countIdioms, possibility, explain) {
    return (
      <>
