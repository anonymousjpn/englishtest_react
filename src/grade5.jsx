...
const Grade5 = () => {
  ...
  const [textValue1, setTextValue1] = useState("c");
  const [textValue2, setTextValue2] = useState("f");
  const [textValue3, setTextValue3] = useState("l");
  const [textValue4, setTextValue4] = useState("k");
  const [textValue5, setTextValue5] = useState("w");
  ...
  const [textValue6, setTextValue6] = useState("c f");
  const [textValue7, setTextValue7] = useState("g u");
  const [textValue8, setTextValue8] = useState("l i");
  const [textValue9, setTextValue9] = useState("o w");
  const [textValue10, setTextValue10] = useState("o t");
