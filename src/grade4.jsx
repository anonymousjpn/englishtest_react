...
const Grade4=()=>{
  ...
  const [textValue1, setTextValue1] = useState("v");
  const [textValue2, setTextValue2] = useState("a");
  const [textValue3, setTextValue3] = useState("s");
  const [textValue4, setTextValue4] = useState("d");
  const [textValue5, setTextValue5] = useState("b");
  ...
  const [textValue6, setTextValue6] = useState("p u");
  const [textValue7, setTextValue7] = useState("t c");
  const [textValue8, setTextValue8] = useState("r a");
  const [textValue9, setTextValue9] = useState("l f");
  const [textValue10, setTextValue10] = useState("e o");
