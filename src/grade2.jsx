...
const Grade2=()=>{
  ...
  const [textValue1, setTextValue1] = useState("h");
  const [textValue2, setTextValue2] = useState("i");
  const [textValue3, setTextValue3] = useState("o");
  const [textValue4, setTextValue4] = useState("a");
  const [textValue5, setTextValue5] = useState("i");
  ...
  const [textValue6, setTextValue6] = useState("a f");
  const [textValue7, setTextValue7] = useState("d h t");
  const [textValue8, setTextValue8] = useState("r f");
  const [textValue9, setTextValue9] = useState("I t l r");
  const [textValue10, setTextValue10] = useState("W r t");
