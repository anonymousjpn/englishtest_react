...
const Grade3 = () => {
  ...
  const [textValue1, setTextValue1] = useState("p");
  const [textValue2, setTextValue2] = useState("s");
  const [textValue3, setTextValue3] = useState("t");
  const [textValue4, setTextValue4] = useState("w");
  const [textValue5, setTextValue5] = useState("c");
  ...
  const [textValue6, setTextValue6] = useState("f a h");
  const [textValue7, setTextValue7] = useState("l f");
  const [textValue8, setTextValue8] = useState("k i t");
  const [textValue9, setTextValue9] = useState("c t");
  const [textValue10, setTextValue10] = useState("l l");
