...
const Grade1 = () => {
  ...
  const [textValue1, setTextValue1] = useState("s");
  const [textValue2, setTextValue2] = useState("T");
  const [textValue3, setTextValue3] = useState("d");
  const [textValue4, setTextValue4] = useState("c");
  ...
  const [textValue6, setTextValue6] = useState("w u");
  const [textValue7, setTextValue7] = useState("p t");
  const [textValue8, setTextValue8] = useState("b t");
  const [textValue9, setTextValue9] = useState("t d");
  const [textValue10, setTextValue10] = useState("C d o");
